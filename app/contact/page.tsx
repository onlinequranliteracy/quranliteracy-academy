      ...
      <div style={{ padding: '3rem 1.5rem' }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            {[
              { icon: '✉️', title: 'Email us', lines: ['onlinequranliteracy@outlook.com'], link: 'mailto:onlinequranliteracy@outlook.com', linkLabel: 'Send an email' },
              { icon: '📱', title: 'WhatsApp', lines: ['+233 24 308 3957', 'Available Sat–Thu, 8am–8pm GMT'], link: 'https://wa.me/233243083957', linkLabel: 'Message us on WhatsApp' },
              { icon: '🌍', title: 'We serve', lines: ['Ghana · United Kingdom · United States', 'Online via WhatsApp & Zoom'], link: null, linkLabel: null },
              { icon: '🕐', title: 'Response time', lines: ['We typically respond within a few hours', 'during business hours (GMT)'], link: null, linkLabel: null },
            ].map((item) => (
          ...
          <div>
            {status === 'sent' ? (
              ...
              <div style={{ background: 'rgba(245,237,216,0.03)', border: '0.5px solid rgba(245,237,216,0.1)', borderRadius: '12px', padding: '2rem' }}>
                <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '22px', fontWeight: 600, color: '#F5EDD8', marginBottom: '1.5rem' }}>Send us a message</h2>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  ...
                  {status === 'error' && (
                    <p style={{ fontSize: '13px', color: '#E07BB5' }}>Something went wrong. Please email us directly at onlinequranliteracy@outlook.com</p>
                  )}
